      ...
      @group.statements.each do |statement|
        ...
        if schoolkid_statement != nil
          if s_s[schoolkid.id.to_s][statement.id.to_s] != ""
            ...
            SchoolkidStatement.where(:statement_id => statement.id, :schoolkid_id => schoolkid.id).first.delete          
          end
        else
          if s_s[schoolkid.id.to_s][statement.id.to_s] != ""
            SchoolkidStatement.create(:statement_id => statement.id, :schoolkid_id => schoolkid.id, :mark => s_s[schoolkid.id.to_s][statement.id.to_s])           
          end
        end
      end              
    end
  ...
  def create_pres
   ...
   @group.schoolkids.each do |schoolkid| 
     @group.statements.each do |statement|
       schoolkid_statement=statement.schoolkid_statements.detect{|ss| ss.schoolkid_id==schoolkid.id}
       if schoolkid_statement
         if s_s[schoolkid.id.to_s][statement.id.to_s].present?
